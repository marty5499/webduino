window.addEventListener('WebComponentsReady', function() {
    ...
    function ctrlPad(state) {
        nowState = state;
        board.board.send([0x90, state, 0x00]);
    }
